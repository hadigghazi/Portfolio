...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            root: ["personal-documents", "progLanguages", "frameworks", "databases", "tools", "theory", "languages", "interests"],
            progLanguages: ["JavaScript", "TypeScript", "PHP","Python", "C", "C++", "Java", "Dart", "Go"],
            frameworks: [ "React",  "Flutter",  "Redux",  "RTK  Query",  "Node.js",  "Express.js",  "Next.js",  'Laravel', 'Scikit-learn', 'Pandas', 'NumPy', 'Matplotlib', 'Streamlit', 'FastAPI', 'Bootstrap', 'Tailwind'],
            databases: ['Microsoft SQL Services', 'MySQL', 'MongoDB'],
            tools: ["GitHub", "Postman", "Figma", "Docker", "AWS Management Console and CLI"],
            theory: ["Complexity Analysis", "Data Structures and Algorithms", "OOP", "Design Patterns", "AWS cloud services"],
            languages: ["Arabic", "English"],
            interests: ["Software Engineering", "AI and ML", "FullStack Development"],
        };
        this.state = {
            terminal: [],
        }
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">hadighazi</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/hadighazi")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-hadi, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
